...
JOptionPane.showMessageDialog(null, "The difference between a random number less than 20 and a random number less than 10 is " + (randomNumber - randomNumber1));
...
{
	JOptionPane.showMessageDialog(null, "MOVE TO SAN DIEGO NOW!!11!1!1!");
}
...
JOptionPane.showMessageDialog(null, "The cars I have have 8 wheels in total.");
